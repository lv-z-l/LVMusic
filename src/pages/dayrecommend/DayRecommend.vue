<template>
  <view class="day-recommend" @click.stop="toDayRecomSongList" :style="{ height: store.imageW + 'px' }">
    ...
    <svg t="1677915968543" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
      p-id="13856" width="148" height="148">
      <path d="M523.9 511.98m-419.5 0a419.5 419.5 0 1 0 839 0 419.5 419.5 0 1 0-839 0Z" fill="#FFD629" p-id="13857">
      </path>
      <path
        ...
        fill="#FF9A2C" opacity=".1" p-id="13858"></path>
      <path
        ...
        fill="#FF9A2C" opacity=".2" p-id="13859"></path>
      <path
        ...
        fill="#FCE99A" opacity=".24" p-id="13860"></path>
      <path
        d="M188.008782 408.574552a136 234.3 54.429 1 0 381.157036-272.589938 136 234.3 54.429 1 0-381.157036 272.589938Z"
        fill="#F9F2D7" opacity=".2" p-id="13861"></path>
      <path d="M616.9 326.38m-52.7 0a52.7 52.7 0 1 0 105.4 0 52.7 52.7 0 1 0-105.4 0Z" fill="rgb(241, 18, 56)"
        p-id="13862"></path>
      <path
      ...
      <path
        ...
        fill="#E53600" opacity=".68" p-id="13865"></path>
      <path
        ...
        fill="#FF9A2C" opacity=".19" p-id="13866"></path>
      <path
        ...
        fill="#FF9A2C" opacity=".15" p-id="13867"></path>
    </svg>
  </view>
</template>
<script setup>
