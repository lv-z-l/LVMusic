<template>
  <view :class="['turntable', store.currentSong.playing ? 'playing' : '']">
    <view class="disc">
      <image src="../../static/disc.1.png" class="disc-1" />
      <image src="../../static/disc-2.png" class="disc-2" />
      <view class="disc-3"></view>
      <image
